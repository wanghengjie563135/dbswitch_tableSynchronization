...
public class MetaDataController {
  ...
  public PageResult<MetadataSchemaDetailResponse> allSchemas(
    ...
    PageResult<MetadataSchemaDetailResponse> metadataSchemaDetailResponsePageResult = metaDataService.allSchemas(id, page, size);
    System.out.println(metadataSchemaDetailResponsePageResult);
  ...
  public PageResult<MetadataTableInfoResponse> allTables(
      ...
      @PathVariable(value = "page", required = false) Integer page,
      @PathVariable(value = "size", required = false) Integer size) {
    PageResult<MetadataTableInfoResponse> metadataTableInfoResponsePageResult = metaDataService.allTables(id, schema, page, size);
    System.out.println(metadataTableInfoResponsePageResult);
  ...
  public Result<MetadataTableDetailResponse> tableMeta(
    ...
    Result<MetadataTableDetailResponse> metadataTableDetailResponseResult = metaDataService.tableDetail(id, schema, table);
    System.out.println(metadataTableDetailResponseResult);
  ...
  public Result<SchemaTableDataResponse> tableData(
      ...
      @RequestParam("schema") String schema,
      @RequestParam("table") String table) {
    Result<SchemaTableDataResponse> schemaTableDataResponseResult = metaDataService.tableData(id, schema, table);
    System.out.println(schemaTableDataResponseResult);
